...
CONSTRAINT `fk_address_city` FOREIGN KEY (`city_id`) REFERENCES `city` (`city_id`) ON DELETE RESTRICT ON UPDATE CASCADE) ENGINE=InnoDB AUTO_INCREMENT=606 DEFAULT CHARSET=utf8;
...
SELECT 
staff.first_name, staff.last_name, SUM(payment.amount) AS total_amt
FROM
staff
LEFT OUTER JOIN
